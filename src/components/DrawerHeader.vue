<template>
    <div class="flex items-center gap-5">
        <svg @click="closeDrawer" class="opacity-30 cursor-pointer hover:opacity-100 transition hover:-translate-x-1"
            fill="#000000" width="26" height="26" viewBox="0 0 200 200" data-name="Layer 1" id="Layer_1"
